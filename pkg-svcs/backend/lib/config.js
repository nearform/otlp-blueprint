...
const config = envSchema({
  ...
  schema: S.object()
    ...
    .prop('OTLP_ENABLE_CONSOLE_LOG', S.string())
    .prop('OTLP_COLLECTOR_URL', S.string())
})
...
module.exports = {
  ...
  otlp: {
    ...
    enableConsoleLog: config.OTLP_ENABLE_CONSOLE_LOG ?? false,
    collectorUrl: config.OTLP_COLLECTOR_URL
  }
}
